            ...
            <AnimatePresence mode="wait">
              ...
              {step === 'confirm' && (
                ...
                >
                  ...
                  {submitError && (
                    <p className="text-yellow-400 text-xs mb-3">{submitError}</p>
                  )}
                  <div className="flex gap-3">
                    <button
                      onClick={() => setStep('calendar')}
                      disabled={submitting}
                      className="flex-1 border border-brand-border text-brand-muted rounded-full py-2.5 text-sm hover:border-white hover:text-white transition-colors disabled:opacity-40"
                    >
                      Modificar
                    </button>
                    <button
                      ...
                      disabled={submitting}
                      className="flex-1 bg-green-500 hover:bg-green-600 text-white rounded-full py-2.5 text-sm font-medium transition-colors flex items-center justify-center gap-2 disabled:opacity-60"
                    >
                      {submitting ? (
                      ...
                      {submitting ? 'Registrando...' : 'Confirmar y enviar WhatsApp'}
                    </button>
                  </div>
                </motion.div>
              )}
